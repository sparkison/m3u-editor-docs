...
>**NOTE**: Plex integration is not yet available but is targeted for a future release. See the roadmap for feature that are coming soon or that are in development. 
